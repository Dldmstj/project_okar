                ...
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6">
                        ...
                        <div class="monthlyRadio">
                            <input type="radio" name="radioBtn" id="12개월" value="12개월" /><label for="12개월"
                                class="radio-inner">12개월</label>
                            <input type="radio" name="radioBtn" id="24개월" value="24개월" /><label for="24개월"
                                class="radio-inner">24개월</label>
                            <input type="radio" name="radioBtn" id="36개월" value="36개월" /><label for="36개월"
                                class="radio-inner">36개월</label>
                            <input type="radio" name="radioBtn" id="48개월" value="48개월" /><label for="48개월"
                                class="radio-inner">48개월</label>
                            <input type="radio" name="radioBtn" id="60개월" value="60개월" /><label for="60개월"
                                class="radio-inner">60개월</label>
                            <input type="radio" name="radioBtn" id="72개월" value="72개월" /><label for="72개월"
