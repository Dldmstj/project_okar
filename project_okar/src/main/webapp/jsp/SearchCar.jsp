                ...
                <div class="d-flex" id="wrapper">
                    ...
                    <div class="border-end bg-white" id="sidebar-wrapper">
                        ...
                        <div style="display: none;" class="list-group list-group-flush" id="kind_Car">
                            <input type="checkbox" name="kind_Car" id="경차" value="경차"/><label>경차</label>
                            <input type="checkbox" name="kind_Car" id="소형차" value="소형차"/><label>소형차</label>
                            <input type="checkbox" name="kind_Car" id="소형차" value="소형차"/><label>준중형차</label>
                            <input type="checkbox" name="kind_Car" id="대형차" value="대형차"/><label>대형차</label>
                            <input type="checkbox" name="kind_Car" id="스포츠카" value="스포츠카"/><label>스포츠카</label>
                            ...
                            <input type="checkbox" name="kind_Car" id="경승합차" value="경승합차"/><label>경승합차</label>
                            <input type="checkbox" name="kind_Car" id="승합차" value="승합차"/><label>승합차</label>
                            <input type="checkbox" name="kind_Car" id="화물차" value="화물차"/><label>화물차</label>
                            <input type="checkbox" name="kind_Car" id="버스" value="버스"/><label>버스</label>
